...
public class createTablesHelper {
	...
	public static List<String> createAndPopulateRepairsTable(){
		...
		tables.add("Insert into repairs(dateStart,dateEnd,carId,note,cost,statusId) "
				+ "values('2017-07-01','2017-07-10',1,'To jest pierwsza naprawa',100,1)");
		tables.add("Insert into repairs(dateStart,dateEnd,carId,note,cost,statusId) "
				+ "values('2017-07-10','2017-07-14',1,'To jest pierwsza naprawa',100,1)");
		tables.add("Insert into repairs(dateStart,dateEnd,carId,note,cost,statusId) "
				+ "values('2017-07-12','2017-07-21',2,'To jest pierwsza naprawa',100,1)");
		tables.add("Insert into repairs(dateStart,dateEnd,carId,note,cost,statusId) "
				+ "values('2017-07-15','2017-07-24',2,'To jest pierwsza naprawa',100,1)");
		tables.add("Insert into repairs(dateStart,dateEnd,carId,note,cost,statusId) "
				+ "values('2017-07-17','2017-07-30',1,'To jest pierwsza naprawa',100,1)");
		return tables;
	}
	...
	public static List<String> createAndPopulateStatusTable(){
		...
		t.add("create table status (id Integer Identity, progress VARCHAR(256))");
